...
describe('UserProfileProfilePanelView', () => {
  it('composes the profile content without profile navigation', () => {
    ...
    expect(profilePicture?.querySelector('.cl-section-media')).toHaveAttribute('data-size', 'xl');
  ...
  it('renders connected accounts and the danger zone when provided', async () => {
    ...
    expect(screen.getByText('This action is permanent and irreversible.')).toHaveClass('cl-section-description');
